...
require.define("/plugins/xx/package.json",function(require,module,exports,__dirname,__filename,process,global){module.exports = {"main":"txtzyme.js"}
});

require.define("/plugins/xx/txtzyme.js",function(require,module,exports,__dirname,__filename,process,global){// Generated by CoffeeScript 1.4.0
(function() {
  var apply, bind, emit, parse, report;
  ...
  emit = function($item, item) {
    ...
    return $item.append("<p class=\"report\" style=\"white-space: pre; white-space: pre-wrap;\">" + (report(parse(item.text))) + "</p>\n<p class=\"caption\">status here</p>");
  };
...
require.define("/plugins/xx/test.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
  var txtzyme;
...
require("/plugins/xx/test.coffee");
})();
